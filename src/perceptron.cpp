...
void Perceptron::predecir(std::vector<string>& ids, std::vector<numeroReal>& predicciones) {
    ...
    cout << "Finalizada la prediccion. Guardando resultados..." << endl << endl;
    /* Se normalizan los productos internos para obtener un valor entre 0 y 1 */
